        ...
        <div>
            ...
            <div class="privacy-theme">
                <section class="boxed-up">
                    ...
                    <h1 class="bold terms">Terms & Conditions</h1>
                    ...
                    <p class="privacy-paragraph">These Terms and Conditions of Service govern your use of our Platform.</p>
                    <p class="privacy-paragraph">Our Privacy Policy also governs your use of our Platform and explains how we collect, safeguard and disclose information that results from your use of our web pages.</p>
                    <p class="privacy-paragraph">Your agreement with us includes these Terms and Conditions as well as our Privacy Policy (“Agreements”). You acknowledge that you have read and understood the Agreements and agree to be bound of them.</p>
                    <p class="privacy-paragraph">If you do not agree with (or cannot comply with) the Agreements, then you may not use the Platform, but please let us know by emailing at <a href="mailto:support@storesnearme.in" class="link-color">support@storesnearme.in</a> so we can try to find a solution. These Terms apply to all visitors, users and others who wish to access or use Platform.</p>
                    <ol class="privacy-thing">
                        <li class="bold headings">How the Service Works</li>
                        <ul class="no-list">
                        ...
                        <li class="bold headings">Accounts</li>
                        <ul class="no-list">
                            ...
                            <li>If you suspect someone else is using your account, let us know by contacting us at <a href="mailto:support@storesnearme.in" class="link-color">support@storesnearme.in</a></li>
                        </ul>
                        <li class="bold headings">Membership</li>
                        <ol class="no-list">
                            <li class="bold">Users</li>
                            <ul class="no-list">
                        ...
                        <li class="bold headings">Interaction with other Members</li>
                        <ol class="some-list">
                        ...
                        <li class="bold headings">Non Solicit</li>
                        <ul class="no-list">
                        ...
                        <li class="bold headings">Content</li>
                        <ul class="no-list">
                        ...
                        <li class="bold headings">Content Posted by You</li>
                        <ul class="no-list">
                        ...
                        <li class="bold headings">Restrictions on Use of Platform</li>
                        <ul class="no-list">
                        ...
                        <li class="bold headings">Intellectual Property</li>
                        <ul class="no-list">
                            <li class="bold">Shops Intellectual Property:</li>
                            <ul class="no-list">
                            ...
                            <li class="bold">IP Infringement Take Downs:</li>
                            <ul class="no-list">
                                <li>Shops respects the intellectual property rights of others. If you believe that material located on or linked to by the Platform violates your copyright, or intellectual property you are encouraged to notify us at <a href="mailto:support@storesnearme.in" class="link-color">support@storesnearme.in</a>.</li>
                        ...
                        <li class="bold headings" id="privacy">Privacy Policy</li>
                        <ul class="no-list">
                        ...
                        <li class="bold headings">Grievance Redressal</li>
                        <ul class="no-list">
                            ...
                            <li>Grievance Officer (provided in accordance with the IT Act, 2000 and its rules): <a href="mailto:support@storesnearme.in" class="link-color">support@storesnearme.in</a></li>
                            <li>Customer Support : Reach out to us on <a href="mailto:support@storesnearme.in" class="link-color">support@storesnearme.in</a> in case of any queries.</li>
                        </ul>
                        <li class="bold headings">Disclaimer</li>
                        <ul class="no-list">
                        ...
                        <li class="bold headings">Limitation of Liability and Indemnification</li>
                        <ul class="no-list">
                        ...
                        <li class="bold headings">Termination and Suspension:</li>
                        <ul class="no-list">
                        ...
                        <li class="bold headings">Miscellaneous</li>
                        <ol class="some-list">
                            <li><span class="bold">Notices:</span> All notices served by SHOPS shall be provided via email to Your account or as a general notification on the Platform. Any notice to be provided to SHOPS should be sent to <a href="mailto:support@storesnearme.in" class="link-color">support@storesnearme.in</a>.</li>
                            <li><span class="bold">Entire Agreement:</span> The Terms, along with the Privacy Policy, and any other guidelines made applicable to the Platform from time to time, constitute the entire agreement between SHOPS and You with respect to Your access to or use of the Platform, Application, Website and the Services thereof.</li>
                            <li><span class="bold">Severability:</span> If, for any reason, a court of competent jurisdiction finds any provision of the Terms, or portion thereof, to be unenforceable, that provision shall be enforced to the maximum extent permissible so as to give effect to the intent of the parties as reflected by that provision, and the remainder of the Terms shall continue in full force and effect.</li>
                            <li><span class="bold">Relief:</span> In the event of You breaching any of these Terms, You agree that SHOPS will be irreparably harmed and may not have an adequate remedy in money or damages. SHOPS therefore, shall be entitled in such event to obtain an injunction against such a breach from any court of competent jurisdiction. SHOPS 's right to obtain such relief shall not limit its right to obtain other remedies.</li>
                            <li><span class="bold">Disputes:</span> The Terms shall be governed by and construed in accordance with the laws of India, without regard to conflict of law principles. Further, the Terms shall be subject to the exclusive jurisdiction of the competent courts located in Bengaluru, India and You hereby accede to and accept the jurisdiction of such Courts.</li>
                            <li><span class="bold">Review:</span> SHOPS provides these Terms so that You are aware of the terms that apply to your use of the Platform and Services. You acknowledge that SHOPS has given You a reasonable opportunity to review these Terms and that You have agreed to them.</li>
                        </ol>
                    </ol>
                </section>
                <footer class="privacy-footer">© Copyrights 2023 | All rights reserved</footer>
            </div>
        </div>
